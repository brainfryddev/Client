...
public final class IfType {
	...
	public static IfType[] aClass15Array1;
	...
	private static LruCache aClass35_6;
	@OriginalMember(owner = "client!hc", name = "ib", descriptor = "Lclient!s;")
	private static LruCache aClass35_7;
	...
	public Pix24[] aClass1_Sub3_Sub2_Sub2Array8;
	...
	public static void method331(@OriginalArg(0) JagFile arg0, @OriginalArg(1) BitmapFont[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) JagFile arg3) {
		try {
			...
			aClass35_7 = new LruCache((byte) 0, 50000);
			@Pc(27) Packet local27 = new Packet(363, arg3.method536("data", null, (byte) 2));
			@Pc(29) int local29 = -1;
			@Pc(32) int local32 = local27.method393();
			aClass15Array1 = new IfType[local32];
			while (true) {
				...
				do {
					...
					local62 = aClass15Array1[local45] = new IfType();
					...
					if (local62.anInt472 == 2) {
						...
						local62.aClass1_Sub3_Sub2_Sub2Array8 = new Pix24[20];
	...
	private static Pix24 method333(@OriginalArg(0) JagFile arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3) {
		try {
			@Pc(8) long local8 = (JString.method540(0, arg2) << 8) + (long) arg1;
			@Pc(13) Pix24 local13 = (Pix24) aClass35_6.method527(local8);
			if (arg3 != -36068) {
	...
	private static Model method334(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(5) Model local5 = (Model) aClass35_7.method527((long) arg1);
			if (arg0 != 4) {
	...
	public Model method332(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(2) Model local2 = this.aClass1_Sub3_Sub1_2;
		if (arg2) {
		...
		if (local2 == null) {
			...
			if (arg0 != -1) {
				local31.method231(-16599, arg0);
			}
			if (arg1 != -1) {
				local31.method231(-16599, arg1);
			}
			local31.method240(64, 768, -50, -10, -50, true);
			return local31;
		}
	}
}
