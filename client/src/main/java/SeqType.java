...
public final class SeqType {
	...
	public static void method374(@OriginalArg(0) JagFile arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(9) Packet local9 = new Packet(363, arg0.method536("seq.dat", null, (byte) 2));
			if (arg1 <= 0) {
	...
	public void method375(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1) {
		try {
			@Pc(5) int local5;
			if (arg0) {
