		...
		try {
			...
			if (arg9 == 22) {
				...
				if (local60.anInt45 != -1) {
					arg1.method453(new LocEntity(true, arg8, arg7, 0, 3, SeqType.aClass19Array1[local60.anInt45], arg3, arg0));
				}
			} else {
				@Pc(174) int local174;
				if (arg9 == 10 || arg9 == 11) {
					...
					if (local60.anInt45 != -1) {
						arg1.method453(new LocEntity(true, arg8, arg7, 0, 2, SeqType.aClass19Array1[local60.anInt45], arg3, arg0));
					}
				} else if (arg9 >= 12) {
					...
					if (local60.anInt45 != -1) {
						arg1.method453(new LocEntity(true, arg8, arg7, 0, 0, SeqType.aClass19Array1[local60.anInt45], arg3, arg0));
					}
				} else if (arg9 == 1) {
					...
					if (arg9 == 2) {
						...
						if (local60.anInt45 != -1) {
							arg1.method453(new LocEntity(true, arg8, arg7, 0, 1, SeqType.aClass19Array1[local60.anInt45], arg3, arg0));
						}
					} else if (arg9 == 5) {
						local430 = 16;
	...
	public void method36(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		try {
			...
			for (@Pc(11) int local11 = 0; local11 < FloType.anInt402; local11++) {
				if (FloType.aClass11Array1[local11].aString19.equalsIgnoreCase("water")) {
				...
				if (arg5 != 22) {
					...
					if (arg5 == 10 || arg5 == 11) {
						...
						if (local84.anInt45 != -1) {
							arg7.method453(new LocEntity(true, arg8, arg2, 0, 2, SeqType.aClass19Array1[local84.anInt45], arg3, arg9));
						}
					} else if (arg5 >= 12) {
						...
						if (local84.anInt45 != -1) {
							arg7.method453(new LocEntity(true, arg8, arg2, 0, 0, SeqType.aClass19Array1[local84.anInt45], arg3, arg9));
						}
						...
						if (arg5 == 2) {
							...
							if (local84.anInt45 != -1) {
								arg7.method453(new LocEntity(true, arg8, arg2, 0, 1, SeqType.aClass19Array1[local84.anInt45], arg3, arg9));
							}
						} else if (arg5 == 5) {
							local810 = 16;
					...
					if (local84.anInt45 != -1) {
						arg7.method453(new LocEntity(true, arg8, arg2, 0, 3, SeqType.aClass19Array1[local84.anInt45], arg3, arg9));
					}
				}
			}
				...
				for (local169 = -5; local169 < this.anInt82 + 5; local169++) {
					for (local191 = 0; local191 < this.anInt83; local191++) {
						...
						if (local204 >= 0 && local204 < this.anInt82) {
							...
							if (local210 > 0) {
								@Pc(378) FloType local378 = FloType.aClass11Array1[local210 - 1];
						...
						if (local210 >= 0 && local210 < this.anInt82) {
							...
							if (local214 > 0) {
								@Pc(451) FloType local451 = FloType.aClass11Array1[local214 - 1];
					...
					if (local169 >= 1 && local169 < this.anInt82 - 1) {
						...
						for (local284 = -5; local284 < this.anInt83 + 5; local284++) {
							...
							if (local284 >= 1 && local284 < this.anInt83 - 1 && (!aBoolean23 || (this.aByteArrayArrayArray1[local7][local169][local284] & 0x10) == 0 && this.method41(local7, (byte) 10, local169, local284) == anInt81)) {
								...
								if (local655 > 0 || local666 > 0) {
									...
									if (local7 > 0) {
										...
										if (local666 > 0 && !FloType.aClass11Array1[local666 - 1].aBoolean91) {
											local807 = false;
										}
									...
									if (local666 == 0) {
										...
										@Pc(925) FloType local925 = FloType.aClass11Array1[local666 - 1];
							...
							for (local139 = 0; local139 <= this.anInt82; local139++) {
								...
								if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local27) != 0) {
									...
									if (local204 >= 8) {
										...
										World3D.method470(local145 * 128 + 128, local139 * 128, -802, local220, 1, local139 * 128, local1127, local214, local141 * 128);
								...
								if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local1123) != 0) {
									...
									if (local204 >= 8) {
										...
										World3D.method470(local133 * 128, local141 * 128, -802, local220, 2, local145 * 128 + 128, local1127, local214, local133 * 128);
										for (local236 = local169; local236 <= local191; local236++) {
											for (local284 = local141; local284 <= local145; local284++) {
								...
								if ((this.anIntArrayArrayArray2[local1145][local139][local133] & local1125) != 0) {
									...
									if ((local145 + 1 - local141) * (local191 + 1 - local169) >= 4) {
										...
										World3D.method470(local191 * 128 + 128, local141 * 128, -802, local204, 4, local145 * 128 + 128, local1127, local204, local169 * 128);
