...
public final class IdkType {
	...
	public static void method304(@OriginalArg(0) JagFile arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(9) Packet local9 = new Packet(363, arg0.method536("idk.dat", null, (byte) 2));
	...
	public void method305(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1) {
		try {
			if (arg0) {
				anInt435 = 65;
			}
