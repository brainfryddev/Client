...
public final class Pix8 extends Draw2D {
	...
	public Pix8(@OriginalArg(0) JagFile arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		@Pc(32) Packet local32 = new Packet(363, arg0.method536(arg1 + ".dat", null, (byte) 2));
		@Pc(42) Packet local42 = new Packet(363, arg0.method536("index.dat", null, (byte) 2));
	...
	public void method350(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		try {
			...
			if (local23 > 0 && local20 > 0) {
				this.method351(Draw2D.anIntArray178, local17, local29, this.aByteArray6, local20, 0, local23, local15, local27, this.anIntArray177);
				if (!arg2) {
					;
				}
			}
