...
public final class Tile extends Linkable {
	...
	public Tile aClass1_Sub2_1;

	@OriginalMember(owner = "client!cb", name = "p", descriptor = "[Lclient!p;")
	public final Loc[] aClass29Array1 = new Loc[5];
