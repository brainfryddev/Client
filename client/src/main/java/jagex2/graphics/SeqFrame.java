...
public final class SeqFrame {
	...
	public static void method276(@OriginalArg(0) boolean arg0, @OriginalArg(1) JagFile arg1) {
		try {
			if (arg0) {
				throw new NullPointerException();
			}
			@Pc(17) Packet local17 = new Packet(363, arg1.method536("frame_head.dat", null, (byte) 2));
			@Pc(27) Packet local27 = new Packet(363, arg1.method536("frame_tran1.dat", null, (byte) 2));
			@Pc(37) Packet local37 = new Packet(363, arg1.method536("frame_tran2.dat", null, (byte) 2));
			@Pc(47) Packet local47 = new Packet(363, arg1.method536("frame_del.dat", null, (byte) 2));
