	...
	private void method535(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte[] arg1) {
		try {
			...
			if (local13 == local10) {
				...
				BZip2.method519(local19, local10, arg1, local13, 6);
				this.aByteArray14 = local19;
				local7 = new Packet(363, this.aByteArray14);
			...
			for (@Pc(27) int local27 = 0; local27 < this.anInt763; local27++) {
				if (this.anIntArray221[local27] == local3) {
					...
					if (this.aBoolean150) {
						...
						BZip2.method519(arg1, this.anIntArray222[local27], this.aByteArray14, this.anIntArray223[local27], this.anIntArray224[local27]);
					}
					return arg1;
				}
			}
