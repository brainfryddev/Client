...
public final class BZip2 {
	...
	private static final Context aClass36_1 = new Context();
	...
	public static int method519(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(3) Context local3 = aClass36_1;
	...
	private static void method521(@OriginalArg(0) Context arg0) {
		...
		arg0.anInt748 = 1;
		if (Context.anIntArray216 == null) {
			Context.anIntArray216 = new int[arg0.anInt748 * 100000];
		}
				...
				while (true) {
					while (local582 != local462) {
						if (local582 == 0 || local582 == 1) {
							...
							while (local592 > 0) {
								Context.anIntArray216[local520] = local64 & 0xFF;
								local520++;
								local592--;
							}
						} else {
							...
							Context.anIntArray216[local520] = arg0.aByteArray10[local64 & 0xFF] & 0xFF;
							local520++;
							if (local551 == 0) {
								local469++;
								local551 = 50;
					...
					for (local164 = 0; local164 < local520; local164++) {
						local64 = (byte) (Context.anIntArray216[local164] & 0xFF);
						Context.anIntArray216[arg0.anIntArray214[local64 & 0xFF]] |= local164 << 8;
						arg0.anIntArray214[local64 & 0xFF]++;
					}
					arg0.anInt751 = Context.anIntArray216[arg0.anInt750] >> 8;
					arg0.anInt753 = 0;
					arg0.anInt751 = Context.anIntArray216[arg0.anInt751];
	...
	private static byte method522(@OriginalArg(0) Context arg0) {
		return (byte) method524(8, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lclient!sb;)B")
	private static byte method523(@OriginalArg(0) Context arg0) {
		return (byte) method524(1, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!sb;)I")
	private static int method524(@OriginalArg(0) int arg0, @OriginalArg(1) Context arg1) {
	...
	private static void method525(@OriginalArg(0) Context arg0) {
		arg0.anInt754 = 0;
