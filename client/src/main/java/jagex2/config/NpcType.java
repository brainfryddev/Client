...
public final class NpcType {
	...
	public static LruCache aClass35_3 = new LruCache((byte) 0, 30);
	...
	private static Packet aClass1_Sub3_Sub3_2;
	...
	public static void method30(@OriginalArg(0) JagFile arg0) {
		aClass1_Sub3_Sub3_2 = new Packet(363, arg0.method536("npc.dat", null, (byte) 2));
		@Pc(21) Packet local21 = new Packet(363, arg0.method536("npc.idx", null, (byte) 2));
	...
	public void method33(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1) {
		try {
			if (arg0) {
	...
	public Model method34(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		@Pc(3) Model local3 = null;
		@Pc(9) Model local9 = (Model) aClass35_3.method527(this.aLong5);
		if (local9 == null) {
			...
			aClass35_3.method528(6, this.aLong5, local9);
		}
