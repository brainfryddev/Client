...
public final class LocType {
	...
	public static LruCache aClass35_1 = new LruCache((byte) 0, 500);
	@OriginalMember(owner = "client!ac", name = "Q", descriptor = "Lclient!s;")
	public static LruCache aClass35_2 = new LruCache((byte) 0, 30);
	...
	private static Packet aClass1_Sub3_Sub3_1;
	...
	public static void method21(@OriginalArg(0) JagFile arg0) {
		aClass1_Sub3_Sub3_1 = new Packet(363, arg0.method536("loc.dat", null, (byte) 2));
		@Pc(21) Packet local21 = new Packet(363, arg0.method536("loc.idx", null, (byte) 2));
	...
	public void method25(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1) {
		try {
			@Pc(5) int local5;
			if (arg0) {
	...
	public Model method26(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		@Pc(56) Model local56 = (Model) aClass35_2.method527(local47);
		@Pc(91) int local91;
		@Pc(141) int local141;
		if (local56 == null) {
			...
			@Pc(200) Model local200 = (Model) aClass35_1.method527((long) local91);
			if (local200 == null) {
				local200 = new Model(false, local91 & 0xFFFF);
				if (local188) {
					local200.method238(-725);
				}
				aClass35_1.method528(6, (long) local91, local200);
			}
			...
			aClass35_2.method528(6, local47, local284);
