...
public final class ObjType {
	...
	public static LruCache aClass35_4 = new LruCache((byte) 0, 50);
	@OriginalMember(owner = "client!cc", name = "U", descriptor = "Lclient!s;")
	public static LruCache aClass35_5 = new LruCache((byte) 0, 200);
	...
	private static Packet aClass1_Sub3_Sub3_3;
	...
	public static void method52(@OriginalArg(0) JagFile arg0) {
		aClass1_Sub3_Sub3_3 = new Packet(363, arg0.method536("obj.dat", null, (byte) 2));
		@Pc(21) Packet local21 = new Packet(363, arg0.method536("obj.idx", null, (byte) 2));
	...
	public static Pix24 method59(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(7) Pix24 local7 = (Pix24) aClass35_5.method527((long) arg0);
			...
			Draw2D.method354(32, local7.anIntArray148, -657, 32);
			...
			if (local28.anInt124 != -1) {
				@Pc(348) Pix24 local348 = method59(local28.anInt123, 24638, 10);
	...
	public void method56(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1) {
		try {
			if (arg0) {
				throw new NullPointerException();
			}
	...
	public Model method58(@OriginalArg(0) int arg0) {
		...
		@Pc(48) Model local48 = (Model) aClass35_4.method527((long) this.anInt103);
		if (local48 != null) {
			return local48;
		}
		...
		aClass35_4.method528(6, (long) this.anInt103, local48);
		return local48;
	}

	@OriginalMember(owner = "client!cc", name = "a", descriptor = "(BI)Lclient!eb;")
	public Model method60(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1) {
		try {
