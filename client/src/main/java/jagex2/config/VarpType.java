...
public final class VarpType {
	...
	public static void method411(@OriginalArg(0) JagFile arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(9) Packet local9 = new Packet(363, arg0.method536("varp.dat", null, (byte) 2));
			anInt606 = 0;
	...
	public void method412(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Packet arg2) {
		try {
			if (arg0 == 13703) {
				while (true) {
