...
public final class WordFilter {
	...
	public static void method414(@OriginalArg(0) JagFile arg0) {
		@Pc(11) Packet local11 = new Packet(363, arg0.method536("fragmentsenc.txt", null, (byte) 2));
		@Pc(21) Packet local21 = new Packet(363, arg0.method536("badenc.txt", null, (byte) 2));
		@Pc(31) Packet local31 = new Packet(363, arg0.method536("domainenc.txt", null, (byte) 2));
		@Pc(41) Packet local41 = new Packet(363, arg0.method536("tldlist.txt", null, (byte) 2));
	...
	private static void method415(@OriginalArg(0) Packet arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) Packet arg2, @OriginalArg(3) Packet arg3) {
	...
	private static void method416(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1) {
		try {
	...
	private static void method417(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1) {
		try {
	...
	private static void method418(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		try {
	...
	private static void method419(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1) {
		try {
	...
	private static void method420(@OriginalArg(0) byte[][][] arg0, @OriginalArg(1) char[][] arg1, @OriginalArg(2) Packet arg2, @OriginalArg(3) byte arg3) {
		try {
			if (arg3 == 1) {
	...
	private static void method421(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) char[][] arg2) {
		try {
			label35: while (true) {
				@Pc(5) int local5;
				if (arg0 >= 0) {
