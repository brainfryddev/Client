...
public final class Client extends GameShell {
	...
	private Pix24 aClass1_Sub3_Sub2_Sub2_1;

	@OriginalMember(owner = "client!client", name = "jf", descriptor = "Lclient!hb;")
	private Pix24 aClass1_Sub3_Sub2_Sub2_2;
	...
	private Pix8[] aClass1_Sub3_Sub2_Sub3Array2;
	...
	private Pix24 aClass1_Sub3_Sub2_Sub2_5;

	@OriginalMember(owner = "client!client", name = "Uf", descriptor = "Lclient!d;")
	private ClientStream aClass6_1;
	...
	private Pix8 aClass1_Sub3_Sub2_Sub3_17;

	@OriginalMember(owner = "client!client", name = "zh", descriptor = "Lclient!ib;")
	private Pix8 aClass1_Sub3_Sub2_Sub3_18;
	...
	private Pix8 aClass1_Sub3_Sub2_Sub3_19;

	@OriginalMember(owner = "client!client", name = "Vh", descriptor = "Lclient!ib;")
	private Pix8 aClass1_Sub3_Sub2_Sub3_20;
	...
	private JagFile aClass39_1;

	@OriginalMember(owner = "client!client", name = "Ki", descriptor = "Lclient!hb;")
	private Pix24 aClass1_Sub3_Sub2_Sub2_11;
	...
	private Packet aClass1_Sub3_Sub3_4 = Packet.method378(1, -737);
	...
	private LinkList aClass28_1 = new LinkList(0);
	...
	private LinkList aClass28_2 = new LinkList(0);
	...
	private Pix24[] aClass1_Sub3_Sub2_Sub2Array3 = new Pix24[20];
	...
	private Pix24[] aClass1_Sub3_Sub2_Sub2Array4 = new Pix24[1000];

	@OriginalMember(owner = "client!client", name = "Ub", descriptor = "I")
	private int anInt185 = 78;

	@OriginalMember(owner = "client!client", name = "Xb", descriptor = "Lclient!kb;")
	private Packet aClass1_Sub3_Sub3_5 = Packet.method378(1, -737);

	@OriginalMember(owner = "client!client", name = "ac", descriptor = "Lclient!kb;")
	private Packet aClass1_Sub3_Sub3_6 = Packet.method378(1, -737);
	...
	private Pix8[] aClass1_Sub3_Sub2_Sub3Array1 = new Pix8[13];
	...
	private Packet[] aClass1_Sub3_Sub3Array1 = new Packet[this.anInt203];

	@OriginalMember(owner = "client!client", name = "Ic", descriptor = "Lclient!ob;")
	private LinkList aClass28_3 = new LinkList(0);
	...
	private LinkList aClass28_4 = new LinkList(0);
	...
	private Pix8[] aClass1_Sub3_Sub2_Sub3Array3 = new Pix8[50];
	...
	private LinkList aClass28_5 = new LinkList(0);
	...
	private Pix24[] aClass1_Sub3_Sub2_Sub2Array6 = new Pix24[8];
	...
	private Pix24[] aClass1_Sub3_Sub2_Sub2Array7 = new Pix24[50];
	...
	private LinkList[][][] aClass28ArrayArrayArray1 = new LinkList[4][104][104];
	...
	public static void method88(@OriginalArg(0) boolean arg0) {
		try {
			...
			World3D.aBoolean143 = true;
			Draw3D.aBoolean96 = true;
			aBoolean53 = true;
			World.aBoolean23 = true;
	...
	public static void method167(@OriginalArg(0) int arg0) {
		try {
			World3D.aBoolean143 = false;
			Draw3D.aBoolean96 = false;
			if (arg0 == 9) {
				aBoolean53 = false;
				World.aBoolean23 = false;
			}
		...
		try {
			...
			for (@Pc(15) int local15 = -1; local15 < this.anInt205 + this.anInt248; local15++) {
				...
				if (local23 != null && local23.method571(false)) {
					...
					if (local23.aString28 != null && (local15 >= this.anInt205 || this.anInt273 == 0 || this.anInt273 == 3 || this.anInt273 == 1 && this.method199(-20, ((PlayerEntity) local23).aString29))) {
					...
					if (local23.anInt898 > anInt266 + 100) {
						...
						if (this.anInt287 > -1) {
							...
							Draw2D.method358(this.anInt288 - 3, this.anInt287 - 15, 65280, (byte) 93, local63, 5);
							Draw2D.method358(this.anInt288 - 3, this.anInt287 - 15 + local63, 16711680, (byte) 93, 30 - local63, 5);
						}
					}
			...
			for (@Pc(483) int local483 = 0; local483 < this.anInt314; local483++) {
				...
				if (this.anInt189 == 0) {
					...
					if (this.anIntArray78[local483] == 2) {
						...
						Draw2D.method356(334, 0, this.anInt287 + 50, 789, this.anInt287 - 50);
	...
	private void method81(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			for (@Pc(1) int local1 = 0; local1 < this.anInt206; local1++) {
				...
				if ((local16 & 0x20) == 32) {
					local13.aClass3_1 = NpcType.method32(arg0.method393());
		...
		try {
			if (arg0 != 0L) {
				if (this.anInt186 >= 100) {
					...
					@Pc(23) String local23 = JString.method542(0, JString.method539(arg0, false));
	...
	private void method83(@OriginalArg(0) byte arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2) {
		try {
			if (arg0 != -45) {
				this.method67();
			}
			...
			if (arg2 == 59 || arg2 == 76) {
				...
				if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
					...
					for (@Pc(74) LocTemporary local74 = (LocTemporary) this.aClass28_4.method456(); local74 != null; local74 = (LocTemporary) this.aClass28_4.method458(551)) {
				...
				if (arg2 == 223) {
					...
					if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
						...
						if (this.aClass28ArrayArrayArray1[this.anInt231][local24][local31] == null) {
							this.aClass28ArrayArrayArray1[this.anInt231][local24][local31] = new LinkList(0);
						}
					...
					local34 = arg1.method393();
					if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
						@Pc(485) LinkList local485 = this.aClass28ArrayArrayArray1[this.anInt231][local24][local31];
						if (local485 != null) {
					...
					if (arg2 == 69) {
						...
						if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104 && local34 >= 0 && local38 >= 0 && local34 < 104 && local38 < 104) {
							...
							@Pc(657) ProjectileEntity local657 = new ProjectileEntity(local572, local110, local31, local108 + anInt266, this.anInt231, local42, local575 + anInt266, local112, 0, this.method94(this.anInt231, local24, (byte) 5, local31) - local52, local47, local24);
							local657.method19(this.method94(this.anInt231, local34, (byte) 5, local38) - local572, local38, local34, -855, local575 + anInt266);
						...
						if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
							local24 = local24 * 128 + 64;
							local31 = local31 * 128 + 64;
							@Pc(753) SpotAnimEntity local753 = new SpotAnimEntity(local24, local34, false, local31, local42, this.method94(this.anInt231, local24, (byte) 5, local31) - local38, this.anInt231, anInt266);
						...
						if (arg2 == 23) {
							...
							if (local921 != null) {
								@Pc(946) LocSpawned local946 = new LocSpawned(this.anInt231, local42, local31, local572 + anInt266, 2, local38, -1, local24, local47);
								this.aClass28_2.method453(local946);
								@Pc(966) LocSpawned local966 = new LocSpawned(this.anInt231, local42, local31, local575 + anInt266, 2, local38, local52, local24, local47);
						...
						if (arg2 == 151) {
							...
							local42 = arg1.method393();
							if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
								@Pc(1178) LinkList local1178 = this.aClass28ArrayArrayArray1[this.anInt231][local24][local31];
								if (local1178 != null) {
			...
			if (arg0) {
				while (this.aBoolean41) {
					...
					if (local19 != null) {
						...
						local69 = (new Packet(363, local52)).method396();
						@Pc(167) byte[] local167 = new byte[local69];
						BZip2.method519(local167, local69, local52, local25, 4);
		...
		try {
			if (arg3.anInt472 == 0 && arg3.anIntArray153 != null && !arg3.aBoolean106 && (arg1 >= arg5 && arg0 >= arg2 && arg1 <= arg5 + arg3.anInt475 && arg0 <= arg2 + arg3.anInt476)) {
				...
				for (@Pc(44) int local44 = 0; local44 < local34; local44++) {
					...
					@Pc(69) IfType local69 = IfType.aClass15Array1[arg3.anIntArray153[local44]];
		...
		try {
			...
			if (super.anInt137 == 1) {
				...
				if (super.anInt138 >= 416 && super.anInt138 <= 516 && super.anInt139 >= 490 && super.anInt139 <= 522) {
					...
					for (@Pc(186) int local186 = 0; local186 < IfType.aClass15Array1.length; local186++) {
						if (IfType.aClass15Array1[local186] != null && IfType.aClass15Array1[local186].anInt474 == 600) {
							this.anInt240 = this.anInt271 = IfType.aClass15Array1[local186].anInt471;
							return;
						}
					}
					return;
	...
	private void method95(@OriginalArg(0) NpcType arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		try {
			...
			if (this.anInt304 < 400) {
				...
				if (arg0.anInt77 != 0) {
					local16 = local16 + method133(this.aClass1_Sub1_Sub3_Sub2_1.anInt932, false, arg0.anInt77) + " (level-" + arg0.anInt77 + ")";
				}
				if (this.anInt281 == 1) {
					...
					while (true) {
						...
						if (this.aBoolean47) {
							...
							if (local13 == 13 || local13 == 10) {
								...
								if (this.anInt168 == 1) {
									local153 = JString.method538(this.aString5);
								...
								if (this.anInt168 == 3 && this.aString5.length() > 0) {
									...
									WordPack.method546(this.aClass1_Sub3_Sub3_6, true, this.aString5);
									this.aClass1_Sub3_Sub3_6.method390(0, this.aClass1_Sub3_Sub3_6.anInt561 - local193);
									this.aString5 = JString.method543(this.aString5, 0);
									this.aString5 = WordFilter.method424(this.aString5, 0);
									this.method172(6, this.aString5, (byte) 4, JString.method542(0, JString.method539(this.aLong8, false)));
									if (this.anInt164 == 2) {
										this.anInt164 = 1;
										this.aBoolean56 = true;
										this.aClass1_Sub3_Sub3_6.method380((byte) -34, 244);
							...
							if ((local13 == 13 || local13 == 10) && this.aString18.length() > 0) {
								if (this.aString18.equals("::clientdrop") && (super.aFrame_Sub1_2 != null || this.method134(-7437).indexOf("192.168.1.") != -1)) {
									...
									WordPack.method546(this.aClass1_Sub3_Sub3_6, true, this.aString18);
									this.aClass1_Sub3_Sub3_6.method390(0, this.aClass1_Sub3_Sub3_6.anInt561 - local693);
									this.aString18 = JString.method543(this.aString18, 0);
									this.aString18 = WordFilter.method424(this.aString18, 0);
	...
	private JagFile method98(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		try {
			@Pc(3) int local3 = 5;
			...
			if (local6 != null) {
				return new JagFile(local6, this.aBoolean55);
			}
			while (local6 == null) {
		...
		try {
			...
			for (@Pc(120) int local120 = 0; local120 < 104; local120++) {
				for (local124 = 0; local124 < 104; local124++) {
					@Pc(136) LinkList local136 = this.aClass28ArrayArrayArray1[this.anInt231][local120][local124];
					if (local136 != null) {
			...
			for (@Pc(235) int local235 = 0; local235 < this.anInt205; local235++) {
				...
				if (local245 != null && local245.method571(false)) {
					...
					@Pc(279) long local279 = JString.method538(local245.aString29);
	...
	private void method105(@OriginalArg(0) int arg0) {
		try {
			...
			if (this.anInt307 == 2) {
				for (@Pc(12) LocSpawned local12 = (LocSpawned) this.aClass28_2.method456(); local12 != null; local12 = (LocSpawned) this.aClass28_2.method458(551)) {
		...
		try {
			...
			if (local8 != 0) {
				...
				if (local61.anInt48 == -1) {
					...
					@Pc(71) Pix8 local71 = this.aClass1_Sub3_Sub2_Sub3Array3[local61.anInt48];
					if (local71 != null) {
			...
			if (local8 != 0) {
				...
				if (local451.anInt48 != -1) {
					@Pc(461) Pix8 local461 = this.aClass1_Sub3_Sub2_Sub3Array3[local451.anInt48];
					if (local461 != null) {
			...
			if (local8 != 0) {
				...
				if (local615.anInt48 != -1) {
					@Pc(625) Pix8 local625 = this.aClass1_Sub3_Sub2_Sub3Array3[local615.anInt48];
					if (local625 != null) {
	...
	private void method108(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		try {
			this.anInt255 = 0;
			this.anInt206 = 0;
	...
	private void method109(@OriginalArg(0) int arg0) {
		try {
			this.aClass1_Sub3_Sub2_Sub3_19 = new Pix8(this.aClass39_1, "titlebox", 0);
			this.aClass1_Sub3_Sub2_Sub3_20 = new Pix8(this.aClass39_1, "titlebutton", 0);
			if (arg0 != 0) {
				this.anInt179 = this.aClass1_Sub3_Sub3_5.method391();
			}
			this.aClass1_Sub3_Sub2_Sub3Array2 = new Pix8[12];
			for (@Pc(32) int local32 = 0; local32 < 12; local32++) {
				this.aClass1_Sub3_Sub2_Sub3Array2[local32] = new Pix8(this.aClass39_1, "runes", local32);
			}
			this.aClass1_Sub3_Sub2_Sub2_3 = new Pix24(128, 265);
			this.aClass1_Sub3_Sub2_Sub2_4 = new Pix24(128, 265);
	...
	private void method110(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2) {
		try {
		...
		try {
			...
			if (arg0 >= 4 && arg0 <= 4) {
				...
				if (this.anInt320 == 2) {
					...
					this.aClass1_Sub3_Sub2_Sub4_3.method367(local21 / 2 - 90, 6, local32, "Username: " + this.aString13 + (this.anInt272 == 0 & anInt266 % 40 < 20 ? "@yel@|" : ""), true, 16777215);
					local32 += 15;
					this.aClass1_Sub3_Sub2_Sub4_3.method367(local21 / 2 - 88, 6, local32, "Password: " + JString.method544(7, this.aString14) + (this.anInt272 == 1 & anInt266 % 40 < 20 ? "@yel@|" : ""), true, 16777215);
					local32 += 15;
					local50 = local21 / 2 - 80;
		...
		try {
			if (this.aClass32_28 == null) {
				...
				if (arg0 == -7185) {
					...
					this.aClass32_28 = new PixMap(this.method72(aByte16), 479, 299, 96);
					this.aClass32_26 = new PixMap(this.method72(aByte16), 168, 299, 160);
					Draw2D.method357(this.anInt336);
					this.aClass1_Sub3_Sub2_Sub3_10.method350(0, 0, false);
					this.aClass32_25 = new PixMap(this.method72(aByte16), 190, 299, 261);
					this.aClass32_27 = new PixMap(this.method72(aByte16), 512, 299, 334);
					Draw2D.method357(this.anInt336);
					this.aClass32_3 = new PixMap(this.method72(aByte16), 501, 299, 61);
					this.aClass32_4 = new PixMap(this.method72(aByte16), 288, 299, 40);
					this.aClass32_5 = new PixMap(this.method72(aByte16), 269, 299, 66);
	...
	private void method118(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Packet arg2) {
		try {
			@Pc(9) int local9;
			if (arg0 < 2 || arg0 > 2) {
	...
	private void method120(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) IfType arg3, @OriginalArg(4) int arg4) {
		try {
			if (arg3.anInt472 == 0 && arg3.anIntArray153 != null && (!arg3.aBoolean106 || this.anInt300 == arg3.anInt470 || this.anInt256 == arg3.anInt470 || this.anInt221 == arg3.anInt470)) {
				...
				Draw2D.method356(arg0 + arg3.anInt476, arg0, arg1 + arg3.anInt475, 789, arg1);
				...
				for (@Pc(59) int local59 = 0; local59 < local57; local59++) {
					...
					@Pc(84) IfType local84 = IfType.aClass15Array1[arg3.anIntArray153[local59]];
					...
					if (local84.anInt472 == 0) {
						...
						if (local84.anInt472 == 2) {
								...
								for (local171 = 0; local171 < local84.anInt475; local171++) {
									...
									if (local84.anIntArray149[local165] > 0) {
										...
										if (local182 >= -32 && local182 <= 512 && local191 >= -32 && local191 <= 334 || this.anInt216 != 0 && this.anInt215 == local165) {
											@Pc(251) Pix24 local251 = ObjType.method59(local224, 24638, local84.anIntArray150[local165]);
											...
											if (local251.anInt465 == 33 || local84.anIntArray150[local165] != 1) {
												...
												this.aClass1_Sub3_Sub2_Sub4_1.method365(local182 + local215 + 1, local191 + 10 + local217, false, 0, method169(true, local351));
												this.aClass1_Sub3_Sub2_Sub4_1.method365(local182 + local215, local191 + 9 + local217, false, 16776960, method169(true, local351));
											}
										}
									} else if (local84.aClass1_Sub3_Sub2_Sub2Array8 != null && local165 < 20) {
										@Pc(398) Pix24 local398 = local84.aClass1_Sub3_Sub2_Sub2Array8[local165];
										if (local398 != null) {
									...
									for (local182 = 0; local182 < local84.anInt475; local182++) {
										if (local84.anIntArray149[local167] > 0) {
											...
											if (local915.aBoolean31 || local84.anIntArray150[local167] != 1) {
												local918 = local918 + " x" + method101(local84.anIntArray150[local167], 0);
											}
							...
							Draw2D.method358(local94, local89, local84.anInt485, (byte) 93, local84.anInt475, local84.anInt476);
						} else {
							Draw2D.method359(3, local89, local84.anInt485, local84.anInt476, local94, local84.anInt475);
						}
					}
				}
	...
	private void method121(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Packet arg2) {
		try {
			for (@Pc(1) int local1 = 0; local1 < this.anInt206; local1++) {
				@Pc(8) int local8 = this.anIntArray40[local1];
			...
			if (arg1 >= 0) {
				...
				if (local28 == 903 || local28 == 363) {
					...
					if (local52 != -1) {
						...
						local69 = JString.method542(0, JString.method539(JString.method538(local48), false));
				...
				if (local28 == 405 || local28 == 38 || local28 == 422 || local28 == 478 || local28 == 347) {
					...
					this.anInt260 = 2;
					if (IfType.aClass15Array1[local23].anInt471 == this.anInt271) {
						this.anInt260 = 1;
					}
					if (IfType.aClass15Array1[local23].anInt471 == this.anInt280) {
						this.anInt260 = 3;
					}
				}
				...
				if (local28 == 188) {
					...
					if (local28 == 679) {
						...
						local52 = local48.indexOf("@whi@");
						if (local52 != -1) {
							local1156 = JString.method538(local48.substring(local52 + 5).trim());
							local73 = -1;
					...
					if (local28 == 930) {
						local1429 = IfType.aClass15Array1[local23];
						this.anInt291 = 1;
						...
						if (local28 == 34) {
							...
							if (local52 != -1) {
								...
								this.aBoolean51 = false;
								for (@Pc(1957) int local1957 = 0; local1957 < IfType.aClass15Array1.length; local1957++) {
									if (IfType.aClass15Array1[local1957] != null && IfType.aClass15Array1[local1957].anInt474 == 600) {
										this.anInt240 = this.anInt271 = IfType.aClass15Array1[local1957].anInt471;
										break;
									}
								}
							}
		...
		try {
			...
			if (local4 >= 1 && local4 <= 100) {
				...
				if (local4 >= this.anInt186) {
					...
					arg1.aString20 = JString.method542(0, JString.method539(this.aLongArray3[local4], false));
					arg1.anInt473 = 1;
				}
			} else if (local4 == 503) {
				...
				if (this.aBoolean39) {
					...
					for (@Pc(213) int local213 = 0; local213 < 7; local213++) {
						...
						if (local220 >= 0) {
							local209[local211++] = IdkType.aClass13Array1[local220].method306();
						}
					}
					...
					local241.method231(-16599, SeqType.aClass19Array1[this.aClass1_Sub1_Sub3_Sub2_1.anInt886].anIntArray186[0]);
	...
	private void method141(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2) {
		try {
			if (arg0) {
				this.method67();
			}
			while (arg1.anInt562 + 21 < arg2 * 8) {
				...
				local36.aClass3_1 = NpcType.method32(arg1.method402(9, 11));
		...
		try {
			...
			if (local4 >= 601 && local4 <= 612) {
				...
				if (this.aString9.length() > 0) {
					...
					this.aClass1_Sub3_Sub3_6.method387(true, JString.method538(this.aString9));
	...
	protected void method67() {
		...
		try {
			...
			@Pc(266) JagFile local266 = this.method98("interface", this.anIntArray38[3], "interface", 20, 0);
			@Pc(277) JagFile local277 = this.method98("2d graphics", this.anIntArray38[4], "media", 30, 0);
			@Pc(288) JagFile local288 = this.method98("3d graphics", this.anIntArray38[5], "models", 40, 0);
			@Pc(299) JagFile local299 = this.method98("textures", this.anIntArray38[6], "textures", 60, 0);
			@Pc(310) JagFile local310 = this.method98("chat system", this.anIntArray38[7], "wordenc", 65, 0);
			@Pc(321) JagFile local321 = this.method98("sound effects", this.anIntArray38[8], "sounds", 70, 0);
			...
			this.aClass1_Sub3_Sub2_Sub3_9 = new Pix8(local277, "invback", 0);
			this.aClass1_Sub3_Sub2_Sub3_11 = new Pix8(local277, "chatback", 0);
			this.aClass1_Sub3_Sub2_Sub3_10 = new Pix8(local277, "mapback", 0);
			this.aClass1_Sub3_Sub2_Sub3_6 = new Pix8(local277, "backbase1", 0);
			this.aClass1_Sub3_Sub2_Sub3_7 = new Pix8(local277, "backbase2", 0);
			this.aClass1_Sub3_Sub2_Sub3_8 = new Pix8(local277, "backhmid1", 0);
			for (@Pc(424) int local424 = 0; local424 < 13; local424++) {
				this.aClass1_Sub3_Sub2_Sub3Array1[local424] = new Pix8(local277, "sideicons", local424);
			}
			this.aClass1_Sub3_Sub2_Sub2_11 = new Pix24(local277, "compass", 0);
			@Pc(450) int local450;
			try {
				for (local450 = 0; local450 < 50; local450++) {
					this.aClass1_Sub3_Sub2_Sub3Array3[local450] = new Pix8(local277, "mapscene", local450);
				}
			} catch (@Pc(468) Exception local468) {
			}
			try {
				for (local450 = 0; local450 < 50; local450++) {
					this.aClass1_Sub3_Sub2_Sub2Array7[local450] = new Pix24(local277, "mapfunction", local450);
				}
			} catch (@Pc(488) Exception local488) {
			}
			try {
				for (local450 = 0; local450 < 20; local450++) {
					this.aClass1_Sub3_Sub2_Sub2Array3[local450] = new Pix24(local277, "hitmarks", local450);
				}
			} catch (@Pc(508) Exception local508) {
			}
			try {
				for (local450 = 0; local450 < 20; local450++) {
					this.aClass1_Sub3_Sub2_Sub2Array5[local450] = new Pix24(local277, "headicons", local450);
				}
			} catch (@Pc(528) Exception local528) {
			}
			this.aClass1_Sub3_Sub2_Sub2_5 = new Pix24(local277, "mapflag", 0);
			for (local450 = 0; local450 < 8; local450++) {
				this.aClass1_Sub3_Sub2_Sub2Array6[local450] = new Pix24(local277, "cross", local450);
			}
			this.aClass1_Sub3_Sub2_Sub2_7 = new Pix24(local277, "mapdots", 0);
			this.aClass1_Sub3_Sub2_Sub2_8 = new Pix24(local277, "mapdots", 1);
			this.aClass1_Sub3_Sub2_Sub2_9 = new Pix24(local277, "mapdots", 2);
			this.aClass1_Sub3_Sub2_Sub2_10 = new Pix24(local277, "mapdots", 3);
			this.aClass1_Sub3_Sub2_Sub3_17 = new Pix8(local277, "scrollbar", 0);
			this.aClass1_Sub3_Sub2_Sub3_18 = new Pix8(local277, "scrollbar", 1);
			this.aClass1_Sub3_Sub2_Sub3_1 = new Pix8(local277, "redstone1", 0);
			this.aClass1_Sub3_Sub2_Sub3_2 = new Pix8(local277, "redstone2", 0);
			this.aClass1_Sub3_Sub2_Sub3_3 = new Pix8(local277, "redstone3", 0);
			this.aClass1_Sub3_Sub2_Sub3_4 = new Pix8(local277, "redstone1", 0);
			this.aClass1_Sub3_Sub2_Sub3_4.method347(-725);
			this.aClass1_Sub3_Sub2_Sub3_5 = new Pix8(local277, "redstone2", 0);
			this.aClass1_Sub3_Sub2_Sub3_5.method347(-725);
			this.aClass1_Sub3_Sub2_Sub3_12 = new Pix8(local277, "redstone1", 0);
			this.aClass1_Sub3_Sub2_Sub3_12.method348((byte) -74);
			this.aClass1_Sub3_Sub2_Sub3_13 = new Pix8(local277, "redstone2", 0);
			this.aClass1_Sub3_Sub2_Sub3_13.method348((byte) -74);
			this.aClass1_Sub3_Sub2_Sub3_14 = new Pix8(local277, "redstone3", 0);
			this.aClass1_Sub3_Sub2_Sub3_14.method348((byte) -74);
			this.aClass1_Sub3_Sub2_Sub3_15 = new Pix8(local277, "redstone1", 0);
			this.aClass1_Sub3_Sub2_Sub3_15.method347(-725);
			this.aClass1_Sub3_Sub2_Sub3_15.method348((byte) -74);
			this.aClass1_Sub3_Sub2_Sub3_16 = new Pix8(local277, "redstone2", 0);
			...
			this.aClass32_6 = new PixMap(this.method72(aByte16), local725.anInt461, 299, local725.anInt462);
			local725.method320(34676, 0, 0);
			@Pc(750) Pix24 local750 = new Pix24(local277, "backleft2", 0);
			this.aClass32_7 = new PixMap(this.method72(aByte16), local750.anInt461, 299, local750.anInt462);
			local750.method320(34676, 0, 0);
			@Pc(775) Pix24 local775 = new Pix24(local277, "backright1", 0);
			this.aClass32_8 = new PixMap(this.method72(aByte16), local775.anInt461, 299, local775.anInt462);
			local775.method320(34676, 0, 0);
			@Pc(800) Pix24 local800 = new Pix24(local277, "backright2", 0);
			this.aClass32_9 = new PixMap(this.method72(aByte16), local800.anInt461, 299, local800.anInt462);
			local800.method320(34676, 0, 0);
			@Pc(825) Pix24 local825 = new Pix24(local277, "backtop1", 0);
			this.aClass32_10 = new PixMap(this.method72(aByte16), local825.anInt461, 299, local825.anInt462);
			local825.method320(34676, 0, 0);
			@Pc(850) Pix24 local850 = new Pix24(local277, "backtop2", 0);
			this.aClass32_11 = new PixMap(this.method72(aByte16), local850.anInt461, 299, local850.anInt462);
			local850.method320(34676, 0, 0);
			@Pc(875) Pix24 local875 = new Pix24(local277, "backvmid1", 0);
			this.aClass32_12 = new PixMap(this.method72(aByte16), local875.anInt461, 299, local875.anInt462);
			local875.method320(34676, 0, 0);
			@Pc(900) Pix24 local900 = new Pix24(local277, "backvmid2", 0);
			this.aClass32_13 = new PixMap(this.method72(aByte16), local900.anInt461, 299, local900.anInt462);
			local900.method320(34676, 0, 0);
			@Pc(925) Pix24 local925 = new Pix24(local277, "backvmid3", 0);
			this.aClass32_14 = new PixMap(this.method72(aByte16), local925.anInt461, 299, local925.anInt462);
			local925.method320(34676, 0, 0);
			@Pc(950) Pix24 local950 = new Pix24(local277, "backhmid2", 0);
			this.aClass32_15 = new PixMap(this.method72(aByte16), local950.anInt461, 299, local950.anInt462);
			...
			World3D.method504(local1312, 800, 512, aByte13, 334, 500);
			WordFilter.method414(local310);
			...
			if (this.anInt216 == 0) {
				...
				if (super.anInt135 > 8 && super.anInt136 > 11 && super.anInt135 < 520 && super.anInt136 < 345) {
					if (this.anInt271 == -1) {
						...
						this.method90(super.anInt136, super.anInt135, 11, IfType.aClass15Array1[this.anInt271], 5082, 8, 0);
					}
				}
				...
				if (super.anInt135 > 562 && super.anInt136 > 231 && super.anInt135 < 752 && super.anInt136 < 492) {
					if (this.anInt330 != -1) {
						this.method90(super.anInt136, super.anInt135, 231, IfType.aClass15Array1[this.anInt330], 5082, 562, 0);
					} else if (this.anIntArray46[this.anInt166] != -1) {
						this.method90(super.anInt136, super.anInt135, 231, IfType.aClass15Array1[this.anIntArray46[this.anInt166]], 5082, 562, 0);
					}
				}
				...
				if (super.anInt135 > 22 && super.anInt136 > 375 && super.anInt135 < 431 && super.anInt136 < 471) {
					if (this.anInt280 == -1) {
						...
						this.method90(super.anInt136, super.anInt135, 375, IfType.aClass15Array1[this.anInt280], 5082, 22, 0);
					}
				}
	...
	private void method144(@OriginalArg(0) byte arg0) {
		try {
			...
			ObjType.aClass35_5.method529();
			PlayerEntity.aClass35_9.method529();
			SpotAnimType.aClass35_8.method529();
	...
	private void method145(@OriginalArg(0) int arg0) {
		try {
			...
			if (this.anInt271 != -1) {
				...
				this.method120(0, 0, 38682, IfType.aClass15Array1[this.anInt271], 0);
			}
			this.method79(39734);
			if (!this.aBoolean50) {
				this.method143(26);
	...
	private void method147(@OriginalArg(0) byte arg0) {
		try {
			...
			for (@Pc(12) ProjectileEntity local12 = (ProjectileEntity) this.aClass28_3.method456(); local12 != null; local12 = (ProjectileEntity) this.aClass28_3.method458(551)) {
				if (local12.anInt24 != this.anInt231 || anInt266 > local12.anInt30) {
					...
					if (local12.anInt33 > 0) {
						...
						if (local42 != null) {
							local12.method19(this.method94(local12.anInt24, local42.anInt882, (byte) 5, local42.anInt883) - local12.anInt28, local42.anInt883, local42.anInt882, -855, anInt266);
						}
					}
					if (local12.anInt33 < 0) {
						...
						if (local80 != null) {
							local12.method19(this.method94(local12.anInt24, local80.anInt882, (byte) 5, local80.anInt883) - local12.anInt28, local80.anInt883, local80.anInt882, -855, anInt266);
						}
					}
	...
	private void method148(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Pix24 arg2, @OriginalArg(3) int arg3) {
		try {
	...
	private void method156(@OriginalArg(0) byte arg0) {
		try {
			if (this.aClass32_16 == null) {
				...
				this.aClass32_19 = new PixMap(this.method72(aByte16), 128, 299, 265);
				Draw2D.method357(this.anInt336);
				this.aClass32_20 = new PixMap(this.method72(aByte16), 128, 299, 265);
				Draw2D.method357(this.anInt336);
				this.aClass32_16 = new PixMap(this.method72(aByte16), 533, 299, 186);
				Draw2D.method357(this.anInt336);
				this.aClass32_17 = new PixMap(this.method72(aByte16), 360, 299, 146);
				Draw2D.method357(this.anInt336);
				this.aClass32_18 = new PixMap(this.method72(aByte16), 360, 299, 200);
				Draw2D.method357(this.anInt336);
				this.aClass32_21 = new PixMap(this.method72(aByte16), 214, 299, 267);
				Draw2D.method357(this.anInt336);
				this.aClass32_22 = new PixMap(this.method72(aByte16), 215, 299, 267);
				Draw2D.method357(this.anInt336);
				this.aClass32_23 = new PixMap(this.method72(aByte16), 86, 299, 79);
				if (arg0 != this.aByte12) {
					this.aClass1_Sub3_Sub3_6.method381(73);
				}
				Draw2D.method357(this.anInt336);
				this.aClass32_24 = new PixMap(this.method72(aByte16), 87, 299, 79);
				Draw2D.method357(this.anInt336);
	...
	private void method159(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2) {
		...
		try {
			...
			this.aClass6_1 = new ClientStream(this, (byte) 2, this.method162(anInt236 + 43594));
			...
			this.aClass1_Sub3_Sub3_6.aClass38_2 = new Isaac((byte) 1, local47);
			for (@Pc(202) int local202 = 0; local202 < 4; local202++) {
				local47[local202] += 50;
			}
			this.aClass38_1 = new Isaac((byte) 1, local47);
			...
			if (local237 == 2 || local237 == 18) {
				...
				this.aClass28_4 = new LinkList(0);
				this.anInt312 = 0;
				this.anInt289 = -1;
				this.anInt280 = -1;
				this.anInt271 = -1;
		...
		try {
			...
			if (arg1 >= 1 && arg2 >= 1 && arg1 <= 102 && arg2 <= 102) {
				...
				if (arg4 >= 0) {
					...
					World.method50(arg1, this.aClass28_1, this.aClass9Array1[arg7], arg2, arg0, this.anIntArrayArrayArray3, 0, arg7, arg4, arg5, this.aClass33_1, local81);
					return;
				}
			}
	...
	private void method163(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) PlayerEntity arg3, @OriginalArg(4) int arg4) {
		try {
			...
			if (arg3 != this.aClass1_Sub1_Sub3_Sub2_1 && this.anInt304 < 400) {
				@Pc(41) String local41 = arg3.aString29 + method133(this.aClass1_Sub1_Sub3_Sub2_1.anInt932, false, arg3.anInt932) + " (level-" + arg3.anInt932 + ")";
				if (this.anInt281 == 1) {
	...
	private void method164(@OriginalArg(0) boolean arg0) {
		try {
			...
			if (this.aBoolean62) {
					...
					if (this.anIntArray45[local46] <= 0) {
						...
						try {
							if (this.anIntArray82[local46] != this.anInt184 || this.anIntArray37[local46] != this.anInt301) {
								@Pc(89) Packet local89 = Wave.method562((byte) -16, this.anIntArray37[local46], this.anIntArray82[local46]);
				...
				@Pc(250) Packet local250 = TrackInput.method210(-809);
				if (local250 != null) {
					...
					if (super.anInt134 == 0) {
						...
						if (this.aBoolean58 && this.anInt247 >= 5) {
							...
							if (this.anInt311 == this.anInt214 && this.anInt310 != this.anInt215) {
								@Pc(502) IfType local502 = IfType.aClass15Array1[this.anInt214];
				...
				if (World3D.anInt714 != -1) {
					local155 = World3D.anInt714;
					local508 = World3D.anInt715;
	...
	private void method165(@OriginalArg(0) boolean arg0) {
		try {
			if (this.anInt304 >= 2 || this.anInt281 != 0 || this.anInt291 != 0) {
				...
				this.aClass1_Sub3_Sub2_Sub4_3.method368(anInt266 / 1000, true, (byte) -121, 15, 16777215, local31, 4);
				if (!arg0) {
					this.anInt179 = -1;
				}
			}
	...
	private void method170(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			this.anInt255 = 0;
			this.anInt206 = 0;
	...
	private boolean method171(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			@Pc(7) IfType local7 = IfType.aClass15Array1[arg0];
			for (@Pc(9) int local9 = 0; local9 < local7.anIntArray153.length && local7.anIntArray153[local9] != -1; local9++) {
				@Pc(24) IfType local24 = IfType.aClass15Array1[local7.anIntArray153[local9]];
	...
	private void method173(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(3) IfType local3 = IfType.aClass15Array1[arg1];
			for (@Pc(5) int local5 = 0; local5 < local3.anIntArray153.length && local3.anIntArray153[local5] != -1; local5++) {
				@Pc(20) IfType local20 = IfType.aClass15Array1[local3.anIntArray153[local5]];
				...
				if (this.aBoolean50) {
					...
					if (local14 == 1 && this.anInt304 > 0) {
						...
						if (local45 == 602 || local45 == 596 || local45 == 22 || local45 == 892 || local45 == 415 || local45 == 405 || local45 == 38 || local45 == 422 || local45 == 478 || local45 == 347 || local45 == 188) {
							...
							@Pc(283) IfType local283 = IfType.aClass15Array1[local124];
							if (local283.aBoolean108) {
								...
								if (IfType.aClass15Array1[local124].anInt471 == this.anInt271) {
									this.anInt216 = 1;
								}
								if (IfType.aClass15Array1[local124].anInt471 == this.anInt280) {
									this.anInt216 = 3;
								}
								return;
							}
	...
	private void method181(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2) {
		try {
			if (arg0 < 0) {
				arg1.method401(223);
	...
	private void method182(@OriginalArg(0) boolean arg0) {
		try {
			if (this.anInt182 > 0) {
				...
				this.aClass32_27.method464(11, super.aGraphics2, 8, 5193);
				this.anInt296 = 0;
				@Pc(60) ClientStream local60 = this.aClass6_1;
				this.aBoolean62 = false;
	...
	private void method183(@OriginalArg(0) int arg0, @OriginalArg(1) Pix8 arg1) {
		try {
			@Pc(3) short local3 = 256;
	...
	private void method184(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(9) LinkList local9 = this.aClass28ArrayArrayArray1[this.anInt231][arg0][arg1];
		if (local9 == null) {
	...
	private void method185(@OriginalArg(0) int arg0) {
		try {
			try {
				...
				System.gc();
				@Pc(53) World local53 = new World(104, this.aByteArrayArrayArray7, 104, this.anIntArrayArrayArray3, this.anInt318);
				@Pc(56) byte[] local56 = new byte[100000];
				@Pc(60) int local60 = this.aByteArrayArray1.length;
				World.aBoolean23 = World3D.aBoolean143;
				@Pc(73) int local73;
				@Pc(80) int local80;
				...
				for (local73 = 0; local73 < local60; local73++) {
					...
					if (local148 != null) {
						local157 = (new Packet(363, local148)).method396();
						BZip2.method519(local56, local157, local148, local148.length - 4, 4);
				...
				for (local80 = 0; local80 < local60; local80++) {
					...
					if (local216 != null) {
						local225 = (new Packet(363, local216)).method396();
						BZip2.method519(local56, local225, local216, local216.length - 4, 4);
				...
				for (@Pc(361) LocTemporary local361 = (LocTemporary) this.aClass28_4.method456(); local361 != null; local361 = (LocTemporary) this.aClass28_4.method458(551)) {
		...
		try {
			...
			try {
				...
				while (true) {
					...
					@Pc(97) int local97;
					if (local35 == 4) {
						local88 = IfType.aClass15Array1[local26[local30++]];
	...
	private void method189(@OriginalArg(0) byte arg0) {
		try {
			...
			this.aClass32_24.method463((byte) 62);
			local14.method320(34676, -180, -186);
			local14 = new Pix24(this.aClass39_1, "logo", 0);
			this.aClass32_16.method463((byte) 62);
		...
		try {
			...
			for (@Pc(52) int local52 = 0; local52 < Model.anInt378; local52++) {
				...
				if (local58 != local41) {
					...
					if (local74 == 3) {
						@Pc(565) LinkList local565 = this.aClass28ArrayArrayArray1[this.anInt231][local62][local68];
						if (local565 != null) {
	...
	private void method195(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Packet arg2) {
		try {
			arg2.method401(223);
	...
	private void method196(@OriginalArg(0) boolean arg0) {
		try {
			...
			if (this.aBoolean47) {
				...
				local135.method365(4, 90, false, 0, JString.method542(0, this.aString13) + ":");
				local135.method365(local135.method364(false, this.aString13 + ": ") + 6, 90, false, 255, this.aString18 + "*");
				Draw2D.method360(0, 0, 77, 479, 0);
			} else {
				this.method120(0, 0, 38682, IfType.aClass15Array1[this.anInt289], 0);
			}
			if (this.aBoolean50 && this.anInt337 == 2) {
				this.method135(-961);
			}
		...
		try {
			...
			try {
				...
				if (this.anInt179 == 152) {
					...
					@Pc(217) String local217 = JString.method542(0, JString.method539(local207, false));
				...
				if (this.anInt179 == 237) {
					...
					for (@Pc(1066) LocTemporary local1066 = (LocTemporary) this.aClass28_4.method456(); local1066 != null; local1066 = (LocTemporary) this.aClass28_4.method458(551)) {
				...
				if (this.anInt179 == 197) {
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					IfType.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = this.aClass1_Sub1_Sub3_Sub2_1.method574(-718);
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 25) {
				...
				if (this.anInt179 == 146) {
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					IfType.aClass15Array1[local159].anInt488 = local462;
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 133) {
					@Pc(1701) Packet local1701 = TrackInput.method211(854);
					if (local1701 != null) {
						this.aClass1_Sub3_Sub3_6.method380((byte) -34, 81);
				...
				if (this.anInt179 == 98) {
					this.aBoolean59 = true;
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					local1745 = IfType.aClass15Array1[local159];
					local211 = this.aClass1_Sub3_Sub3_5.method391();
				...
				if (this.anInt179 == 140) {
					...
					if (this.anInt299 != 0 && this.anInt271 == -1) {
						Signlink.dnslookup(JString.method541(-946, this.anInt299));
						this.method77((byte) -60);
						...
						this.aString9 = "";
						this.aBoolean51 = false;
						for (local462 = 0; local462 < IfType.aClass15Array1.length; local462++) {
							if (IfType.aClass15Array1[local462] != null && IfType.aClass15Array1[local462].anInt474 == local1915) {
								this.anInt271 = IfType.aClass15Array1[local462].anInt471;
								break;
							}
						}
					}
				...
				if (this.anInt179 == 212) {
					if (this.aBoolean42 && !aBoolean53) {
						...
						BZip2.method519(local2018, local462, this.aClass1_Sub3_Sub3_5.aByteArray7, local211, this.aClass1_Sub3_Sub3_5.anInt561);
				...
				if (this.anInt179 == 12) {
					...
					if (this.aBoolean73 && !aBoolean53 && this.anInt286 < 50) {
						...
						this.anIntArray45[this.anInt286] = local211 + Wave.anIntArray231[local159];
						this.anInt286++;
					}
					this.anInt179 = -1;
					return true;
				...
				if (this.anInt179 == 204) {
					...
					IfType.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = local2130.method35(false);
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 7) {
				...
				if (this.anInt179 == 103) {
					...
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					local211 = this.aClass1_Sub3_Sub3_5.method393();
					local2181 = IfType.aClass15Array1[local159];
				...
				if (this.anInt179 == 135) {
					...
					for (@Pc(2487) LocTemporary local2487 = (LocTemporary) this.aClass28_4.method456(); local2487 != null; local2487 = (LocTemporary) this.aClass28_4.method458(551)) {
				...
				if (this.anInt179 == 41) {
					...
					if (!local2652 && this.anInt191 == 0) {
						try {
							...
							@Pc(2721) String local2721 = WordPack.method545(this.aClass1_Sub3_Sub3_5, 118, this.anInt178 - 13);
							@Pc(2725) String local2725 = WordFilter.method424(local2721, 0);
							if (local466 > 1) {
								this.method172(7, local2725, (byte) 4, JString.method542(0, JString.method539(local207, false)));
							} else {
								this.method172(3, local2725, (byte) 4, JString.method542(0, JString.method539(local207, false)));
							}
				...
				if (this.anInt179 == 87) {
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					IfType.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = new Model(false, local462);
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 4) {
					...
					if (local1264.endsWith(":tradereq:")) {
						...
						local3043 = JString.method538(local3040);
						local2652 = false;
				...
				if (this.anInt179 == 46) {
					...
					IfType.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = local3157.method58(50);
					IfType.aClass15Array1[local159].anInt491 = local3157.anInt106;
					IfType.aClass15Array1[local159].anInt492 = local3157.anInt107;
					IfType.aClass15Array1[local159].anInt490 = local3157.anInt105 * 100 / local211;
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 2) {
					...
					IfType.aClass15Array1[local159].anInt485 = (local211 << 19) + (local466 << 11) + (local219 << 3);
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 26) {
					...
					IfType.aClass15Array1[local159].aBoolean106 = local3362;
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 21) {
				...
				if (this.anInt179 == 201) {
					...
					IfType.aClass15Array1[local159].aString20 = local3040;
					if (IfType.aClass15Array1[local159].anInt471 == this.anIntArray46[this.anInt166]) {
						this.aBoolean59 = true;
					}
					this.anInt179 = -1;
					return true;
				...
				if (this.anInt179 == 184) {
					...
					if (this.anInt307 == 1) {
						this.anInt307 = 2;
						World.anInt81 = this.anInt231;
						this.method185(869);
					}
					if (aBoolean53 && this.anInt307 == 2 && World.anInt81 != this.anInt231) {
						this.aClass32_27.method463((byte) 62);
						this.aClass1_Sub3_Sub2_Sub4_2.method362(151, (byte) 6, 0, "Loading - please wait.", 257);
						this.aClass1_Sub3_Sub2_Sub4_2.method362(150, (byte) 6, 16777215, "Loading - please wait.", 256);
						this.aClass32_27.method464(11, super.aGraphics2, 8, 5193);
	...
	private void method198(@OriginalArg(0) byte arg0) {
		try {
			...
			if (this.anInt330 != -1) {
				this.method120(0, 0, 38682, IfType.aClass15Array1[this.anInt330], 0);
			} else if (this.anIntArray46[this.anInt166] != -1) {
				this.method120(0, 0, 38682, IfType.aClass15Array1[this.anIntArray46[this.anInt166]], 0);
			}
			if (this.aBoolean50 && this.anInt337 == 1) {
				this.method135(-961);
			}
	...
	private void method200(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Packet arg3, @OriginalArg(4) PlayerEntity arg4) {
		try {
			if (!arg0) {
				this.aBoolean44 = !this.aBoolean44;
			}
			...
			if ((arg2 & 0x40) == 64) {
				...
				if (arg4.aString29 != null) {
					@Pc(209) long local209 = JString.method538(arg4.aString29);
					...
					if (!local211 && this.anInt191 == 0) {
						try {
							@Pc(244) String local244 = WordPack.method545(arg3, 118, local199);
							@Pc(248) String local248 = WordFilter.method424(local244, 0);
			...
			if ((arg2 & 0x200) == 512) {
				...
				arg4.anInt921 = arg3.method393() + anInt266;
				arg4.anInt922 = arg3.method393() + anInt266;
