...
public final class FloType {
	...
	public static FloType[] aClass11Array1;
	...
	public static void method272(@OriginalArg(0) JagFile arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(9) Packet local9 = new Packet(363, arg0.method536("flo.dat", null, (byte) 2));
	...
	public void method273(@OriginalArg(0) boolean arg0, @OriginalArg(1) Packet arg1) {
		try {
			if (arg0) {
