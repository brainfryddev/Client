...
public final class Hashtable {
	...
	public Linkable method530(@OriginalArg(0) long arg0) {
		@Pc(11) Linkable local11 = this.aClass1Array1[(int) (arg0 & (long) (this.anInt757 - 1))];
		for (@Pc(14) Linkable local14 = local11.aClass1_41; local14 != local11; local14 = local14.aClass1_41) {
	...
	public void method531(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Linkable arg2) {
		try {
			if (arg2.aClass1_42 != null) {
				arg2.method567();
			}
			@Pc(18) Linkable local18 = this.aClass1Array1[(int) (arg0 & (long) (this.anInt757 - 1))];
