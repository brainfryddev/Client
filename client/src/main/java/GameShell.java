...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	protected final void method62(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			this.anInt131 = arg1;
			this.anInt132 = arg0;
			this.aFrame_Sub1_2 = new Viewbox(this.anInt132, 35731, this, this.anInt131);
			this.aGraphics2 = this.method72(this.aByte7).getGraphics();
			this.aClass32_2 = new PixMap(this.method72(this.aByte7), this.anInt131, 299, this.anInt132);
	...
	public final void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		...
		if (TrackInput.aBoolean81) {
			TrackInput.method213(local2, arg0.isMetaDown() ? 1 : 0, local5, (byte) 4);
		}
	}
	...
	public final void mouseReleased(@OriginalArg(0) MouseEvent arg0) {
		...
		this.anInt134 = 0;
		if (TrackInput.aBoolean81) {
			TrackInput.method214(arg0.isMetaDown() ? 1 : 0, 0);
		}
	}
	...
	public final void mouseDragged(@OriginalArg(0) MouseEvent arg0) {
		...
		if (TrackInput.aBoolean81) {
			TrackInput.method215(local5, true, local2);
		}
	}
	...
	public final void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		...
		if (TrackInput.aBoolean81) {
			TrackInput.method216(local10, true);
		}
	}
